...
//
//        hasEmptySubset = setsToCover.stream().anyMatch(i -> i == 0);
//
...
//            sb.getEleStream().forEach(e -> subsetParts.get(e).add(sb));
//
...
//        for (List<Subset> subsetsWithE : subsetParts)
...
//                    potential = true;
//                    and.stream().forEach(e -> nd.removeEle(e, subsetParts.get(e)));
//                }
//            }
